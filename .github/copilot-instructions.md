# Scrinium — GitHub Copilot Instructions
...
- CLI entry point: `scrinium --help`
- Python package: `scrinium/`
- Paper data: `data/papers/<Author-Year-Title>/` (meta.json + paper.md + notes.md)
- User output: always write to `workspace/`, never to project root or `scrinium/`
