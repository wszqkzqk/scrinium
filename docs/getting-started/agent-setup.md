...
|-------|----------------------------|
| Codex / OpenClaw / Cursor / Windsurf / Copilot / Cline / opencode / Kimi Code / Qwen Code | Reads `AGENTS.md` natively; skills discovered via `.agents/skills/` or `.claude/skills/` |
